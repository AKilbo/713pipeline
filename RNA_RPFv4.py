...
def change_dir():
    ...
    os.system("cp ~/Spar_ultrascaf.fa ~/"+outputDir) 
    print(os.getcwd())
...
def create_blocks():
    ...
    os.system("bedtools merge -i reads.sort.bed > "+
...
def findORFs(charSearchRange):
    ...
    with open(genome) as theGenome:
	    ...
	    regionDict=getOffsets(orgGenome,genomeShortcut + "-regionResults.txt")
	    lineNumber = 0
		...
		lineNumber += 1
                ...
                posCorrection = regionDict.get(findLoc[0])
